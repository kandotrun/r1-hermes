...
def main() -> None:
    ...
    serve.add_argument("--state-dir", default=str(Path.home() / ".r1-hermes"))
    serve.add_argument("--host", default=os.environ.get("R1_HERMES_HOST", "127.0.0.1"))
    serve.add_argument("--port", type=int, default=int(os.environ.get("R1_HERMES_PORT", "18789")))
    ...
    if args.command == "serve":
        ...
        adapter = R1HermesAdapter(config, message_handler=_demo_handler)
